...
jawab = MsgBox("Apakah yakin mau menghapus data dengan kode " & ListView1.SelectedItem.SubItems(1) & "", vbYesNo, "Konfirmasi")
    If jawab = vbYes Then
    HapusData "Barang", "kode_barang", ListView1.SelectedItem.SubItems(1)
    ReloadData
End If
End Sub
...
With AddBarang
    ...
    .txtkategori.Text = ListView1.SelectedItem.SubItems(7) + "-" + ListView1.SelectedItem.SubItems(5)
    .txtketerangan.Text = ListView1.SelectedItem.SubItems(6)
    .Show
End With
End Sub
