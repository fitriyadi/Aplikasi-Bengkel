...
Begin VB.Form BrowsePemasok 
   ...
   Begin VB.Label Label1 
      ...
      Caption         =   "* Double Click / [Enter] Untuk Memilih Data Pemasok"
      Height          =   255
      Left            =   120
      TabIndex        =   3
      Top             =   4680
   ...
   Begin VB.Image cmdKeluar 
      Height          =   240
      Left            =   14160
      Picture         =   "BrowsePemasok.frx":0000
      Stretch         =   -1  'True
      Top             =   240
      Width           =   240
   End
   ...
   End
End
Attribute VB_Name = "BrowsePemasok"
...
Sub PilihData()
With FormPembelian
    .txtkodepemasok.Text = ListView1.SelectedItem.SubItems(1)
    .txtnamapemasok.Text = ListView1.SelectedItem.SubItems(2)
    .txtnohp.Text = ListView1.SelectedItem.SubItems(3)
End With
    Unload Me
End Sub
